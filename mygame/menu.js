var menu = {
    ...
    create: function () {
        ...
        this.text=game.add.text(20, 40, "FIGHT FOR THE CITY", { font: "74px Arial Black", fill: "#ba6b00" });
        this.text.stroke = "#640000";
        this.text.strokeThickness = 16;
        this.text.setShadow(2, 2, "#333333", 2, false, false);
        this.text=game.add.text(300, 440, "PLAY", { font: "40px Arial Black", fill: "#000000" });
